...
ConsoleFont% = AALoadFont("GFX\font\cour\Courier New.ttf", Int(19 * (GraphicHeight / 1024.0)), 0,0,0) ; AALoadFont("Blitz", Int(20 * (GraphicHeight / 1024.0)), 0,0,0,1) - iconic but.. disgusting!
